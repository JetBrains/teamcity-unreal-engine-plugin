...
object ComponentParametersFormatter {
    fun formatFlags(flags: Sequence<CheckboxParameter>, properties: Map<String, String>) =
        flags
            .filter {
    ...
    fun formatFlag(flag: CheckboxParameter, properties: Map<String, String>): String =
        if (properties.containsKey(flag.name)) "Yes" else "No"
}
